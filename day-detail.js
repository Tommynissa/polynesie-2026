const guides = [
  ...
  {id:'10',dow:'Samedi',island:'Huahine',title:'Moorea → Huahine',lede:'Retour matinal à Tahiti, vol Air Tahiti vers Huahine, installation au Bungalow Vanille et récupération du scooter.',timeline:[['Tôt','Ferry Moorea → Tahiti','Choisir une traversée permettant d’être à l’aéroport vers 9 h.'],['10:50','Vol VT310','Tahiti-Faa’a → Huahine-Fare.'],['11:30','Arrivée à Huahine','Récupération des bagages.'],['Midi','Transfert et scooter','Prévenir la pension 24 h avant pour l’accueil.'],['14:00','Check-in','Installation au Bungalow Vanille, puis découverte de Fare.']],facts:[['Transport','Ferry + avion + scooter'],['Bagage','15 kg en soute / personne'],['Hébergement','Bungalow Vanille'],['Référence','Air Tahiti IBKEN8']],tips:['Louer le scooter jusqu’au 14 octobre vers 9 h.','Demander une restitution près de la pension ou du quai pour éviter les bagages en scooter.','Check-in annoncé entre 14 h et 18 h.'],places:[['Aéroport de Huahine-Fare','Arrivée du vol VT310','Huahine Fare Airport'],['Bungalow Vanille','Route de l’aéroport, Fare 98731','Bungalow Vanille Fare Huahine','+689 40 68 71 77'],['Fare','Village, courses et front de mer','Fare Huahine']]},
  {id:'11',dow:'Dimanche',island:'Huahine',title:'Panoramas, Chez Tara et Hana Iti',lede:'Grande boucle du sud en scooter : vues faciles sur le lagon, four tahitien chez Tara puis plage sauvage de Hana Iti.',timeline:[['08:30','Départ du Bungalow Vanille','Route vers Huahine Iti.'],['09:15','Belvédère de Maroe','Arrêt photo avec très peu de marche.'],['10:00','Panorama de Tefarerii','Point de vue accessible et très photogénique.'],['11:00','Four tahitien Chez Tara','Déjeuner sur la plage d’Avea, réservation indispensable.'],['14:00','Plage Hana Iti','Baignade et snorkeling, accès à confirmer avec le repère photo.'],['17:00','Retour à Fare','Retour par Haapu et Fitii.']],facts:[['Transport','Scooter'],['Repas','Chez Tara vers 11 h'],['Budget repas','≈ 5 000 F / personne'],['À emporter','Espèces + snorkeling']],tips:['Réserver Chez Tara et demander une table face au lagon.','Le paiement en espèces est conseillé.','Pour Hana Iti, conserver la photo d’accès hors ligne et demander confirmation à la pension.'],places:[['Belvédère de Maroe','Vue sur la baie','Belvedere de Maroe Huahine'],['Panorama de Tefarerii','Point de vue sur le lagon','Panorama de Tefarerii Huahine'],['Chez Tara','Plage d’Avea, Parea 98731','-16.811325,-150.989456','+689 40 68 78 45'],['Plage Hana Iti','Accès près de Vairupe Vanille','Plage Hana Iti Huahine']],photo:true},
